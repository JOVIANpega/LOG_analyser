...
class ExcelWriter:
    ...
    def export_pass_fail_workbooks(self, folder_path: str, pass_logs: list, fail_logs: list):
        ...
        - FAIL匯總.xlsx：Summary + 每個 FAIL LOG 的工作表 (旧格式)
        - FAIL匯總_新版.xlsx：Dashboard + FAIL_LIST + 每個 FAIL LOG 的工作表 (新格式) ⭐
        ...
        fail_path_new = os.path.join(folder_path, 'FAIL匯總_新版.xlsx')
        ...
        # 生成FAIL工作簿 (新格式) ⭐
        self._build_fail_workbook_new_format(fail_path_new, fail_logs)
